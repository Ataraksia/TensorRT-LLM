...
from tensorrt_llm.functional import Tensor, gather_last_token_logits, gelu
    ...
    def forward(
        ...
        **kwargs,
        ...
        if attention_mask is not None:
            if mode == GenerationMode.AUDIO_IN_PROGRESS:
...
class HiggsAudioModel(Module):
    ...
    def __init__(self, config: HiggsAudioConfig, dtype: str = "bfloat16"):
        ...
        self.layers = ModuleList(
            [
                HiggsAudioDualFFNDecoderLayer(config=config, layer_idx=i, dtype=dtype)
