...
from ...lora_manager import LoraConfig, get_default_trtllm_modules_to_hf_modules, use_lora
=======
...
<<<<<<< HEAD
from ..modeling_utils import DecoderLayerList, DecoderModelForCausalLM, QuantConfig
from .config import QWenConfig
from .convert import load_hf_qwen, load_weights_from_hf_gptq_model, load_weights_from_hf_model
...
<<<<<<< HEAD
        self.input_layernorm = RmsNorm(
            normalized_shape=config.hidden_size, eps=config.norm_epsilon, dtype=dtype
        )
