...
from .higgs_audio.config import HiggsAudioConfig, HiggsAudioEncoderConfig
...
# from .higgs_audio.model import HiggsAudioForCausalLM  # TODO: Uncomment when model is implemented
...
MODEL_MAP = {
    ...
    # 'HiggsAudioForCausalLM': HiggsAudioForCausalLM,  # TODO: Uncomment when model is implemented
    # 'HiggsAudioForConditionalGeneration': HiggsAudioForCausalLM,  # TODO: Uncomment when model is implemented
    # 'HiggsAudioModel': HiggsAudioForCausalLM,  # TODO: Uncomment when model is implemented
}
